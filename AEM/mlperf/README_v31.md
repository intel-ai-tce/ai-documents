...
Intel has participated in Mleprf submissions since the very beginning of the foundation of this organization. In December 2018 Intel published the first Mlperf training benchmark suite together with Goodle and Nvidia. So far, there have been more than 100 results were submitted on Xeon. From 2018 till now, Intel has always been playing the leading role in mlcommons. And in recent submissions, Intel is the only CPU submitter in DataCenter benchmarking, which makes Intel as the part of few players within Mlcommons who own and influence new benchmarks.
...
For your convinience, we prepare a set of automation scritps to help you prepare required Datasets, Models, and Docker Images for each of the worlkloads. This set of automation scritps can also automatically run model performance benchmarking. 
